...
import HeaderImage from '../assets/header-tasty-logo-1200x800.jpg';
...
const Home = () => {
    ...
    return (
        <>
            <Header/>
            <main>
                <div className="hero-banner__ pb-3">
                    <div className="hero-banner__wrapper">
                        <img src={HeaderImage} alt=""/>
                        <div className="hero-banner__title">
                            <h2 className="pb-3">Laissez-vous guider par votre gourmandise</h2>
                            <a className="pt-3" href="#project-container">
                ...
                <section id="project-container" className="flex-center">
                    <div className="position-relative container pt-3 pb-3 ">
                        <div className="api-container flex-start pb-1">
                            <span>Utiliser l'API Places:</span>
                            <input
                            id="s2" className="switch"
                                type="checkbox"
                                checked={useApi}
